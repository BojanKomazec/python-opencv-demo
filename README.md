OpenCV demo project in Python (Notebook)
...
```
$ conda env create -f python_opencv_demo_linux.yml
$ conda activate python_opencv_demo
$ jupyter-lab
```
...
## How to run Python Notebook is VS Code

Make sure you have Python and Jupyter plugins installed and enabled.

CTRL+SHIFT+P >> Python: Select Interpreter >> select python interpreter executable:
```
Python 3.6.6 64-bit ('python_opencv_demo': conda)
~/anaconda3/envs/python_opencv_demo/bin/python
```

Re-open VS Code window for this project.

## Credits

Image that I saved under name `data/OpenCV-CheatSheet.jpg` is created by Pratham Prasoon (@PrasoonPratham).
